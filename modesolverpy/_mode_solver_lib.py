...
class _ModeSolverVectorial():
    ...
    def compute_other_fields(self, neffs, Hxs, Hys):
        ...
        for neff, Hx, Hy in zip(neffs, Hxs, Hys):
            ...
            tmp_8 = (w * exx4 + e * exx1)
            tmp_9 = (n + s) * exx2 * exx3
            tmp_10 = ezz1 / exx4 * ezz4 * e
            tmp_11 = (e + w) * eyy4 * eyy3
            ...
            bzxse = (-0.5 * tmp_1 * eyx3 / ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / (e + w) * eyy4 * eyy1 * w * eyy2 +
                     0.5 * (ezz4 / tmp_5 + tmp_10) * (1 - exx3 / ezz3) / tmp_7 / ezz4 / ezz1 / tmp_8 / (n + s) * exx2 * n * exx1 * exx4) / b

            bzxnw = (-0.5 * tmp_3 * eyx1 / ezz4 / ezz3 / tmp_6 / ezz1 / tmp_2 / tmp_11 * eyy2 * e -
                     0.5 * tmp_4 * (1 - exx1 / ezz1) / ezz3 / ezz2 / tmp_7 / tmp_8 / tmp_9 * exx4 * s) / b

            bzxsw = (0.5 * tmp_3 * eyx2 / ezz4 / ezz3 / tmp_6 / ezz2 / tmp_2 / tmp_11 * eyy1 * e -
                     0.5 * (ezz4 / tmp_5 + tmp_10) * (1 - exx2 / ezz2) / tmp_7 / ezz4 / ezz1 / tmp_8 / (n + s) * exx3 * n * exx1 * exx4) / b

            bzxn = ((0.5 * tmp_3 * n * ezz1 * ezz2 / eyy1 * (2 * eyy1 / ezz1 / n ** 2 + eyx1 / ezz1 / n / w) + 0.5 * tmp_1 * n * ezz4 * ezz3 / eyy4 * (2 * eyy4 / ezz4 / n ** 2 - eyx4 / ezz4 / n / e)) / ezz4 / ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w * eyy2 * e + (tmp_4 * (0.5 * ezz4 * ((1 - exx1 / ezz1) / n / w - exy1 / ezz1 *
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (2. / n ** 2 - 2 / n ** 2 * s / (n + s))) / tmp_5 + (ezz4 - ezz1) * s / n / (n + s) + 0.5 * ezz1 * (-(1 - exx4 / ezz4) / n / e - exy4 / ezz4 * (2. / n ** 2 - 2 / n ** 2 * s / (n + s))) / exx4 * ezz4 * e) - (ezz4 / tmp_5 + tmp_10) * (-ezz3 * exy2 / n / (n + s) / exx2 * w + (ezz3 - ezz2) * s / n / (n + s) - ezz2 * exy3 / n / (n + s) / exx3 * e)) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b

            bzxs = ((0.5 * tmp_3 * s * ezz2 * ezz1 / eyy2 * (2 * eyy2 / ezz2 / s ** 2 - eyx2 / ezz2 / s / w) + 0.5 * tmp_1 * s * ezz3 * ezz4 / eyy3 * (2 * eyy3 / ezz3 / s ** 2 + eyx3 / ezz3 / s / e)) / ezz4 / ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w * eyy2 * e + (tmp_4 * (-ezz4 * exy1 / s / (n + s) / exx1 * w - (ezz4 - ezz1)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   * n / s / (n + s) - ezz1 * exy4 / s / (n + s) / exx4 * e) - (ezz4 / tmp_5 + tmp_10) * (0.5 * ezz3 * (-(1 - exx2 / ezz2) / s / w - exy2 / ezz2 * (2. / s ** 2 - 2 / s ** 2 * n / (n + s))) / exx2 * ezz2 * w - (ezz3 - ezz2) * n / s / (n + s) + 0.5 * ezz2 * ((1 - exx3 / ezz3) / s / e - exy3 / ezz3 * (2. / s ** 2 - 2 / s ** 2 * n / (n + s))) / exx3 * ezz3 * e)) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b

            bzxe = (tmp_1 * (0.5 * n * ezz4 * ezz3 / eyy4 * (2. / e ** 2 - eyx4 / ezz4 / n / e) + 0.5 * s * ezz3 * ezz4 / eyy3 * (2. / e ** 2 + eyx3 / ezz3 / s / e)) / ezz4 / ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w * eyy2 * e +
                    (-0.5 * tmp_4 * ezz1 * (1 - exx4 / ezz4) / n / exx4 * ezz4 - 0.5 * (ezz4 / tmp_5 + tmp_10) * ezz2 * (1 - exx3 / ezz3) / s / exx3 * ezz3) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b

            bzxw = (tmp_3 * (0.5 * n * ezz1 * ezz2 / eyy1 * (2. / w ** 2 + eyx1 / ezz1 / n / w) + 0.5 * s * ezz2 * ezz1 / eyy2 * (2. / w ** 2 - eyx2 / ezz2 / s / w)) / ezz4 / ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w * eyy2 * e +
                    (0.5 * tmp_4 * ezz4 * (1 - exx1 / ezz1) / n / exx1 * ezz1 + 0.5 * (ezz4 / tmp_5 + tmp_10) * ezz3 * (1 - exx2 / ezz2) / s / exx2 * ezz2) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b

            bzxp = ((tmp_3 * (0.5 * n * ezz1 * ezz2 / eyy1 * (-2. / w ** 2 - 2 * eyy1 / ezz1 / n ** 2 + k ** 2 * eyy1 - eyx1 / ezz1 / n / w) + 0.5 * s * ezz2 * ezz1 / eyy2 * (-2. / w ** 2 - 2 * eyy2 / ezz2 / s ** 2 + k ** 2 * eyy2 + eyx2 / ezz2 / s / w)) + tmp_1 * (0.5 * n * ezz4 * ezz3 / eyy4 * (-2. / e ** 2 - 2 * eyy4 / ezz4 / n ** 2 + k ** 2 * eyy4 + eyx4 / ezz4 / n / e) + 0.5 * s * ezz3 * ezz4 / eyy3 * (-2. / e ** 2 - 2 * eyy3 / ezz3 / s ** 2 + k ** 2 * eyy3 - eyx3 / ezz3 / s / e))) / ezz4 / ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w * eyy2 * e + (tmp_4 * (0.5 * ezz4 * (-k **
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     2 * exy1 - (1 - exx1 / ezz1) / n / w - exy1 / ezz1 * (-2. / n ** 2 - 2 / n ** 2 * (n - s) / s)) / tmp_5 + (ezz4 - ezz1) * (n - s) / n / s + 0.5 * ezz1 * (-k ** 2 * exy4 + (1 - exx4 / ezz4) / n / e - exy4 / ezz4 * (-2. / n ** 2 - 2 / n ** 2 * (n - s) / s)) / exx4 * ezz4 * e) - (ezz4 / tmp_5 + tmp_10) * (0.5 * ezz3 * (-k ** 2 * exy2 + (1 - exx2 / ezz2) / s / w - exy2 / ezz2 * (-2. / s ** 2 + 2 / s ** 2 * (n - s) / n)) / exx2 * ezz2 * w + (ezz3 - ezz2) * (n - s) / n / s + 0.5 * ezz2 * (-k ** 2 * exy3 - (1 - exx3 / ezz3) / s / e - exy3 / ezz3 * (-2. / s ** 2 + 2 / s ** 2 * (n - s) / n)) / exx3 * ezz3 * e)) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b
            ...
            bzyse = (-0.5 * tmp_1 * (1 - eyy3 / ezz3) / tmp_6 / ezz2 / ezz1 / tmp_2 / (e + w) * eyy4 * eyy1 * w *
                     eyy2 + 0.5 * (ezz4 / tmp_5 + tmp_10) * exy3 / ezz3 / tmp_7 / ezz4 / ezz1 / tmp_8 / (n + s) * exx2 * n * exx1 * exx4) / b

            bzynw = (-0.5 * tmp_3 * (1 - eyy1 / ezz1) / ezz4 / ezz3 / tmp_6 / tmp_2 / tmp_11 *
                     eyy2 * e - 0.5 * tmp_4 * exy1 / ezz3 / ezz2 / tmp_7 / ezz1 / tmp_8 / tmp_9 * exx4 * s) / b

            bzysw = (0.5 * tmp_3 * (1 - eyy2 / ezz2) / ezz4 / ezz3 / tmp_6 / tmp_2 / tmp_11 * eyy1 *
                     e - 0.5 * (ezz4 / tmp_5 + tmp_10) * exy2 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / (n + s) * exx3 * n * exx1 * exx4) / b

            bzyn = ((0.5 * tmp_3 * ezz1 * ezz2 / eyy1 * (1 - eyy1 / ezz1) / w - 0.5 * tmp_1 * ezz4 * ezz3 / eyy4 * (1 - eyy4 / ezz4) / e) / ezz4 / ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w *
            ...
            bzys = ((-0.5 * tmp_3 * ezz2 * ezz1 / eyy2 * (1 - eyy2 / ezz2) / w + 0.5 * tmp_1 * ezz3 * ezz4 / eyy3 * (1 - eyy3 / ezz3) / e) / ezz4 / ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w *
                    eyy2 * e - (ezz4 / tmp_5 + tmp_10) * (0.5 * ezz3 * (2. / s ** 2 - exy2 / ezz2 / s / w) / exx2 * ezz2 * w + 0.5 * ezz2 * (2. / s ** 2 + exy3 / ezz3 / s / e) / exx3 * ezz3 * e) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b
            ...
            bzye = ((tmp_3 * (-n * ezz2 / eyy1 * eyx1 / e / (e + w) + (ezz1 - ezz2) * w / e / (e + w) - s * ezz1 / eyy2 * eyx2 / e / (e + w)) + tmp_1 * (0.5 * n * ezz4 * ezz3 / eyy4 * (-(1 - eyy4 / ezz4) / n / e - eyx4 / ezz4 * (2. / e ** 2 - 2 / e ** 2 * w / (e + w))) + 0.5 * s * ezz3 * ezz4 / eyy3 * ((1 - eyy3 / ezz3) / s / e - eyx3 / ezz3 * (2. / e ** 2 - 2 / e ** 2 * w / (e + w))) + (ezz4 - ezz3) * w / e / (e + w))) / ezz4 /
                    ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w * eyy2 * e + (0.5 * tmp_4 * ezz1 * (2 * exx4 / ezz4 / e ** 2 - exy4 / ezz4 / n / e) / exx4 * ezz4 * e - 0.5 * (ezz4 / tmp_5 + tmp_10) * ezz2 * (2 * exx3 / ezz3 / e ** 2 + exy3 / ezz3 / s / e) / exx3 * ezz3 * e) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b
            ...
            bzyw = ((tmp_3 * (0.5 * n * ezz1 * ezz2 / eyy1 * ((1 - eyy1 / ezz1) / n / w - eyx1 / ezz1 * (2. / w ** 2 - 2 / w ** 2 * e / (e + w))) - (ezz1 - ezz2) * e / w / (e + w) + 0.5 * s * ezz2 * ezz1 / eyy2 * (-(1 - eyy2 / ezz2) / s / w - eyx2 / ezz2 * (2. / w ** 2 - 2 / w ** 2 * e / (e + w)))) + tmp_1 * (-n * ezz3 / eyy4 * eyx4 / w / (e + w) - s * ezz4 / eyy3 * eyx3 / w / (e + w) - (ezz4 - ezz3) * e / w / (e + w))) / ezz4 /
                    ezz3 / tmp_6 / ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w * eyy2 * e + (0.5 * tmp_4 * ezz4 * (2 * exx1 / ezz1 / w ** 2 + exy1 / ezz1 / n / w) / tmp_5 - 0.5 * (ezz4 / tmp_5 + tmp_10) * ezz3 * (2 * exx2 / ezz2 / w ** 2 - exy2 / ezz2 / s / w) / exx2 * ezz2 * w) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b
            ...
            bzyp = ((tmp_3 * (0.5 * n * ezz1 * ezz2 / eyy1 * (-k ** 2 * eyx1 - (1 - eyy1 / ezz1) / n / w - eyx1 / ezz1 * (-2. / w ** 2 + 2 / w ** 2 * (e - w) / e)) + (ezz1 - ezz2) * (e - w) / e / w + 0.5 * s * ezz2 * ezz1 / eyy2 * (-k ** 2 * eyx2 + (1 - eyy2 / ezz2) / s / w - eyx2 / ezz2 * (-2. / w ** 2 + 2 / w ** 2 * (e - w) / e))) + tmp_1 * (0.5 * n * ezz4 * ezz3 / eyy4 * (-k ** 2 * eyx4 + (1 - eyy4 / ezz4) / n / e - eyx4 / ezz4 * (-2. / e ** 2 - 2 / e ** 2 * (e - w) / w)) + 0.5 * s * ezz3 * ezz4 / eyy3 * (-k ** 2 * eyx3 - (1 - eyy3 / ezz3) / s / e - eyx3 / ezz3 * (-2. / e ** 2 - 2 / e ** 2 * (e - w) / w)) + (ezz4 - ezz3) * (e - w) / e / w)) / ezz4 / ezz3 / tmp_6 /
                    ezz2 / ezz1 / tmp_2 / tmp_11 * eyy1 * w * eyy2 * e + (tmp_4 * (0.5 * ezz4 * (-2. / n ** 2 - 2 * exx1 / ezz1 / w ** 2 + k ** 2 * exx1 - exy1 / ezz1 / n / w) / tmp_5 + 0.5 * ezz1 * (-2. / n ** 2 - 2 * exx4 / ezz4 / e ** 2 + k ** 2 * exx4 + exy4 / ezz4 / n / e) / exx4 * ezz4 * e) - (ezz4 / tmp_5 + tmp_10) * (0.5 * ezz3 * (-2. / s ** 2 - 2 * exx2 / ezz2 / w ** 2 + k ** 2 * exx2 + exy2 / ezz2 / s / w) / exx2 * ezz2 * w + 0.5 * ezz2 * (-2. / s ** 2 - 2 * exx3 / ezz3 / e ** 2 + k ** 2 * exx3 - exy3 / ezz3 / s / e) / exx3 * ezz3 * e)) / ezz3 / ezz2 / tmp_7 / ezz4 / ezz1 / tmp_8 / tmp_9 * n * exx1 * exx4 * s) / b
